        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5>Pemesanan anda sudah berhasil dicheck out selanjutnya untuk pembayaran silahkan transfer di rekening dibawah ini :</h5><br>
                    <p><strong>Bank BRI Nomer Rekening : 0357-01-029311-504</p>
                    <p>An. Encep Nurdin</strong> dengan nominal : <strong>Rp. {{ number_format($pesanan->kode+$pesanan->jumlah_harga) }}</strong></p>
                </div>
            </div>
            <div class="card mt-2">
                <div class="card-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $pesanan_detail->barang->kategori_produk }}</td>
